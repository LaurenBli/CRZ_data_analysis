...
INPUT = "data/processed/subway_did_panel.parquet"

OUT_RESULTS = "outputs/models/10a_event_study_subway_results.txt"
OUT_FIGURE = "outputs/figures/10a_event_study_subway.png"
OUT_COEFS = "outputs/models/10a_event_study_subway_coefficients.csv"
OUT_COV = "outputs/models/10a_event_study_subway_covariance.csv"

os.makedirs("outputs/models", exist_ok=True)
os.makedirs("outputs/figures", exist_ok=True)

print("=" * 90)
print("Loading Subway DiD panel...")
print("=" * 90)
...
df = df[df["subway_ridership"] >= 0].copy()
...
print("=" * 90)
print("Running Subway event study regression...")
print("=" * 90)
...
with open(OUT_RESULTS, "w", encoding="utf-8") as f:
    f.write("=" * 90 + "\n")
    f.write("10a Subway Event Study Results\n")
    f.write("=" * 90 + "\n\n")
    ...
    f.write("log_subway_ridership ~ event_time × treated_group\n")
...
plt.title("Subway Event Study: Congestion Pricing Effect")
plt.xlabel("Months Relative to Policy Start (January 2025)")
plt.ylabel("Treatment Effect on Log Subway Ridership")
plt.grid(alpha=0.25)
...
print("=" * 90)
print("Subway Event Study complete")
print("=" * 90)
